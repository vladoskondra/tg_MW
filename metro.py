...
import datetime
import math
from modules.gps.gpsGo import gps
import re
...
stationNames = ['Белорусская (зеленая)', 'Маяковская', 'Тверская', 'Театральная', 'Новокузнецкая', 'Павелецкая (зеленая)', 'Менделеевская', 'Цветной бульвар', 'Чеховская', 'Боровицкая', 'Полянка', 'Серпуховская', 'Достоевская', 'Трубная', 'Сретенский бульвар', 'Чкаловская', 'Проспект мира (оранжевая)', 'Сухаревская', 'Тургеневская', 'Китай-город (оранжевая)', 'Третьяковская (оранжевая)', 'Октябрьская (оранжевая)', 'Комсомольская (красная)', 'Красные ворота', 'Чистые пруды', 'Лубянка', 'Охотный ряд', 'Библиотека им. Ленина', 'Кропоткинская', 'Парк культуры (красная)', 'Курская (синяя)', 'Площадь революции', 'Арбатская (синяя)', 'Смоленская (синяя)', 'Киевская (синяя)', 'Таганская (фиолетовая)', 'Китай-город (фиолетовая)', 'Кузнецкий мост', 'Пушкинская', 'Баррикадная', 'Марксистская', 'Третьяковская (желтая)', 'Киевская (голубая)', 'Смоленская (голубая)', 'Арбатская (голубая)', 'Александровский сад', 'Белорусская (кольцевая)', 'Новослободская', 'Суворовская', 'Проспект мира (кольцевая)', 'Комсомольская (кольцевая)', 'Курская (кольцевая)', 'Таганская (кольцевая)', 'Павелецкая (кольцевая)', 'Добрынинская', 'Октябрьская (кольцевая)', 'Парк культуры (кольцевая)', 'Киевская (кольцевая)', 'Краснопресненская']


# .NewMessage(chats=('IlotTowerBot'))
